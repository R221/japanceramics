            ...
            <div className="col-12 col-md-10 col-lg-6 offset-md-1 offset-lg-0">
              ...
              {checkout && (
                <form onChange={this.handleChangeForm} onSubmit={this.captureOrder}>
                  <p className="font-size-subheader font-weight-semibold mb-4">To Who?</p>
                  <div className="row">
                  ...
                  <p className="font-size-subheader font-weight-semibold mb-4">Where To?</p>
                  <div className="mb-5">
                    <AddressForm
                      type="shipping"
                    ...
                    >
                      ...
                      />
                      <p>
                        Receive exciting additions and updates in your mailbox. Rest assured, you
                        will not be flooded, we only send one newsletter per month approximately 🙂
                      </p>
                    </div>
